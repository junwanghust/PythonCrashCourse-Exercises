...
info = make_album('仓木麻衣', 'Secret of my heart')
print(info)
info = make_album('Schumann', 'Album for the Young')
print(info)
info = make_album('David Gray', 'White Ladder')
print(info)

info = make_album('Schumann', 'Album for the Young', 'Soldatenmarsch ')
print(info)
